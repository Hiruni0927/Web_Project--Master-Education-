...
if (isset(($_GET["email"]))) {
  ...
  $dbinfo = "SELECT name,email,phone,date,stream,password from signup where email='$em'";
    ...
    <div class="container py-5">
      <div class="row align-items-center">
        ...
        <div class="col-lg-7">
          <div class="text-left mb-4">
            <form>
              <div class="mb-3">
                ...
                <div class="output"> <span><br></span></div>
              </div>
              <div class="mb-3">
          ...
          <div class="btnbtn">
            <a href="" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Save</a>
          
            <a href="" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Reset</a>
          </div>
          <div class="btnbtn2">
          <a href="subjectS.html" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Go to subject stream</a>
          </div>
        </div>
      </div>
    </div>
